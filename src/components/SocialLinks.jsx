...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/priyanshu-101",
    icon: (
  ...
  {
    name: "LinkedIn",
    url: "https://linkedin.com/in/priyanshu-101",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
const SocialLinks = () => {
  return (
    <section className="flex flex-col items-center py-8 animate-fade-in">
      <h2 className="text-2xl font-extrabold gradient-text mb-6">Connect with me</h2>
      <div className="flex gap-6 flex-wrap justify-center">
        {socialLinks.map((link) => (
          <a
            ...
            className="btn-secondary flex items-center gap-2 animate-scale-in hover:scale-110"
